...
% JD: Nice roundup here.

% JD: It's "memorability!"
...
% JD: These do exist, and in the latest OSes, this is built in.  Have you tried one?
...
% JD: "Misspelled" is misspelled, LOL.
...
% JD: The main jump you are making here is the connection to programming languages
%     and libraries.  The other features are fairly typical in speech-enabled text
%     editors these days.
...
% JD: Now this is intriguing, but is best expressed with an example.  I tried to
%     say something then imagine myself hitting Tab to autocomplete, and to be
%     honest it was faster to just finish my word or maybe sentence.  You need
%     to dig into this more deeply.
...
% JD: You have some good conceptual call-outs here, but they are already well-known
%     ones in the service of well-known user interface elements.  Better that you
%     apply the same thinking to *your* user interface innovations.
...
% JD: Yes, this has potential.  But how is it different from just separate windows
%     that the user rearranges himself/herself?
...
% JD: I'm not very clear on what purpose this locking serves.
...
%Well, Gimp certainly is interesting.
\begin{figure}[h!]
    \centering
...
% JD: Yeah we're not worried about this definition of efficiency.
...
% JD: Actually, direct manipulation is pretty common now---virtually every text editor
%     that I know supports drag-and-drop.
